...
abstract class TVRemoteDataSource {
  ...
  Future<TVEpisodeModel> getEpisodeDetail(int id, int season, int episode);
}
...
class TVRemoteDataSourceImpl implements TVRemoteDataSource {
  ...
  @override
  Future<TVEpisodeModel> getEpisodeDetail(
      int id, int season, int episode) async {
    final response = await client.get(
        Uri.parse('$BASE_URL/tv/$id/season/$season/episode/$episode?$API_KEY'));
